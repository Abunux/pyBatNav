...
\hline
Nombre de coups moyens $\conj x$ & 44,29 & 42,79 & 42,21 & 42,63\\
\hline
Écart-type\footnote{Vu la taille importante des échantillons nous prendrons $\sigma_\text{estimé}=\sigma_{échantillon}$}  $\sigma$ & 6,62 & 6,28 & 6,10 & 5,89\\
\hline
Temps moyen par partie (en secondes) & 0,29 & 2,8 & 26,6 & 287\\
\hline 
\end{tabular}\\
\end{center}
