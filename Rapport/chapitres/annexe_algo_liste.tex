...
Certes, sur une grille vide, on pourrait jouer avec les symétries (et diviser le calcul par $8$) mais cette symétrie est tout de suite brisée dès qu'une case a été jouée.
