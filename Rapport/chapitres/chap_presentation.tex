...
\item On peut tout à fait concevoir ce jeu comme un jeu à un seul joueur.
\end{itemize}
...
\item \texttt{bn\_stats.py} : fournit les outils d'analyses statistiques des résultats de l'algorithme de résolution.
