...
L'algorithme de résolution est implémenté dans la classe \texttt{Ordi(Joueur)} du module \texttt{bn\_joueur.py} (qui hérite donc de la classe \texttt{Joueur}), dans la méthode \texttt{Ordi.coup\_suivant(self)}.
