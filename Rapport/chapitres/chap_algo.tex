...
Un test de l'algorithme de résolution sur $n=1\,000\,000$ de parties donne les résultats suivants, obtenus avec les modules \texttt{numpy} et \texttt{matplotlib} :
