...
Des tests de l'algorithme de résolution sur $n=1\,000\,000$ de parties donnent le résultat suivants, obtenus avec les modules \texttt{numpy} et \texttt{matplotlib} :

\begin{center}
\fbox{\includegraphics[scale=0.8]{./media/distrib_1000000.png}}
\end{center}